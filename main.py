...
print(fila_teste_2.estatistica(EstatisticaDetalhada("10/01/1980", 198)))
print(fila_teste_2.estatistica(EstatisticaResumida("10/01/1980", 198)))
...
print(teste_fabrica.chama_cliente(5))
print(teste_fabrica.chama_cliente(2))
print(fila_teste_2.estatistica(EstatisticaDetalhada("10/01/2080", 200)))
print(fila_teste_2.estatistica(EstatisticaResumida("10/01/2080", 200)))
